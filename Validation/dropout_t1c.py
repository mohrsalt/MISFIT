...
val_set_folder = '/home/users/ntu/mohor001/scratch/Task8DataBrats/ValData' 
val_set_missing = '/home/users/ntu/mohor001/scratch/Task8DataBrats/pseudo_val_set_t1c'
...
folder_list.sort()
drop_index = np.random.randint(0, 1, size=len(folder_list))
